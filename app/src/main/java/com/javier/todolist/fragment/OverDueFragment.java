...
public class OverDueFragment extends Fragment implements IUpdateListCallBack, IClickItemListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = view.findViewById(R.id.recycler_view_overdue);
